...
/* USER CODE BEGIN PFP */
//void led_1(GPIO_PinState led_state);
//void led_2(GPIO_PinState led_state);
//void led_3(GPIO_PinState led_state);
...
void led_2(GPIO_PinState led_state){
	HAL_GPIO_WritePin(LED_YELLOW_GPIO_Port, LED_YELLOW_Pin, led_state);
}
void led_2(GPIO_PinState led_state){
