 ...
 while (1)
 {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  if (tick >= 100) {
	              ...
	              seg_count++;
	              if (seg_count >= 10) seg_count = 0;
	              display7SEG(seg_count);
	          }
	  tick++;
	  HAL_Delay(10);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, SEG0_Pin|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3
  ...
  /*Configure GPIO pins : SEG0_Pin PB1 PB2 PB3
                           PB4 PB5 PB6 */
  GPIO_InitStruct.Pin = SEG0_Pin|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3
